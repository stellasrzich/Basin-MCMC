"""Given a single atom, compute the Laplace approximation to the posterior at 
that atom, where the observed data is defined to be the noise-free data generated 
by the chosen atom.

One can show that, at the chosen atom, the exact Hessian of the log likelihood is
