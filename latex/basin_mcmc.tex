...
To develop it, I will complete the following tasks:
\begin{itemize}
  \item Decide how to choose the initial probability distribution for a basin given an initial representative state
  \item Decide what the perturb moves should be. That is, decide what the local sampler for each basin should be. This includes how we propose from the basin probability distribution, and how we adapt the basin probability distribution and probability
  \item Decide what the birth/death move should be
  \item Decide what the merge/split move should be
  \item Decide how to choose a move
  \item Prove that the adaption is diminishing, and so the chain is ergodic. 
